...
figlet("Cedric AUDRIT", function (err, nameASCI) {
  ...
  const data = {
    ...
    funct: chalk.magenta("Junior WebDev / SysAdmin"),
    npm:
      chalk.cyan("                   https://npmjs.com/") +
      chalk.green("~freecey"),
    github:
      chalk.cyan("                https://github.com/") +
      chalk.green("freecey"),
    linkedin:
      chalk.cyan("   https://linkedin.com/in/") + chalk.green("cedric-audrit"),
